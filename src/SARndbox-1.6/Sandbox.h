...
class Sandbox:public Vrui::Application,public GLObject
	...
	class LocalWaterTool:public Vrui::Tool,public Vrui::Application::Tool<Sandbox>,public Vrui::TransparentObject
		...
		//					Modificado								//
		//////////////////////////////////////////////////////////////
		void registerPoint();//FURB
		void activeWaterSources(); //FURB
		};
	...
	//					Modificado								//
	//////////////////////////////////////////////////////////////
	GLMotif::ToggleButton* onWaterSourceToggle; // FURB
	GLMotif::PopupWindow* waterSourceControlDialog; //FURB
	GLMotif::TextFieldSlider* waterSourceSizeSlider;
	double sizeSource = 0.5;
	...
	//					Modificado								//
	//////////////////////////////////////////////////////////////
	void onWaterSourceCallback(GLMotif::ToggleButton::ValueChangedCallbackData* cbData);//FURB
	void startBackgroundCapture(void);
	...
	void startTiePointCapture(void);
	...
	//						Modificado			       		    //
	//////////////////////////////////////////////////////////////
	void showWaterSourceControlDialogCallback(Misc::CallbackData* cbData);
	void waterSourceSizeSliderCallback(GLMotif::TextFieldSlider::ValueChangedCallbackData* cbData);
	...
	//						Modificado			       		    //
	//////////////////////////////////////////////////////////////
	GLMotif::PopupWindow* createWaterSourceControlDialog(void);
